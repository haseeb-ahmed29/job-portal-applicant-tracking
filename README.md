# Job Portal & Applicant Tracking

Job listings, applicants, pipeline stages and interview-ready workflow. This repository is a runnable ASP.NET Core MVC 8.0 + EF Core SQLite foundation intended for extension into a full management product.
